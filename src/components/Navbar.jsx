...
export default function Navbar() {
  ...
  return (
    <nav
      ref={navRef}
      className="fixed top-0 inset-x-0 z-50 h-20 bg-maroon/85 backdrop-blur-md border-b border-sand/20"
    >
      {/* Wood texture overlay */}
      <div aria-hidden="true" style={{
        position: 'absolute', inset: 0,
        backgroundImage: 'url(/img/texture-wood.jpg)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        opacity: 0.4,
        pointerEvents: 'none',
      }} />
      <div className="container flex items-center justify-between h-full relative z-10">
      ...
      <div className="flex items-center gap-8">
        ...
        <a href="#" className="nav-link text-cream hover:text-sky transition-all duration-400">
          ...
          <a href="#coffees" className="nav-link border-2 text-cream px-4 py-2 rounded-full hover:bg-cream hover:border-cream hover:text-maroon
